...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sequenceList.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.sequenceList.setHorizontalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self.sequenceList.setAlternatingRowColors(False)
